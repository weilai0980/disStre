...
//	private Fields _fields;
	...
	public double diviNum = Math.exp(Math.log(TopologyMain.approBoltNum)
...
//					/ taskGridCap);
			...
			tmpUpBound2 = (int) Math.ceil((double) (tmpGridCoor[j] + 2)
					/ taskGridCap);
...
//			
			...
			tasklist.add(_tasks.get((int) Math.ceil(tmptaskId) - 1));
