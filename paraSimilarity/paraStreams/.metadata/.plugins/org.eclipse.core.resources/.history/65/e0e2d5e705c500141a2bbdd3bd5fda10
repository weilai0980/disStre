...
//	 public static final int aggreBoltNum = 1;
	...
	public static int winSize = 150; // 20 40 80 160 320 640 1280
	...
	public static int nstream = 2500;  //3500, 1700 
...
//	threshold, sliding window 
	...
	public static final int taskCell=2;
...
//	public static final String rp_matFile = "rhp-vectors.txt";
	...
	public static void main(String[] args) throws InterruptedException,
		...
		else if (appro.compareTo("cptest") == 0) {

			CommonProjectTool cp=new CommonProjectTool(10);
			
			System.out.printf(" +++++++++++++++++++++  correlation from dis and direct way: %f   %f\n", cp.correlationFromDis(),cp.correlationDirect());
		
			double corre[]= new double[4];
		    cp.cp_correlation(corre);
		    
			System.out.printf(" +++++++++++++++++++++  correlation from commone-project: %f   %f\n",corre[0], corre[1]);
