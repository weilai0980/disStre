...
public class AdjustApproBolt extends BaseBasicBolt {
	...
	int[] gridPivot = new int[TopologyMain.gridIdxN];
	int[] gridBolt = new int[TopologyMain.gridIdxN];
	int gridIdxcnt = 0;
	// int[] gridIdxFlag = new int[TopologyMain.gridIdxN];

	int[][] gridCoors = new int[TopologyMain.gridIdxN + 5][TopologyMain.winSize + 5];
	double[][] gridAffs = new double[TopologyMain.gridIdxN + 5][3 * TopologyMain.nstream];
	double[][] pivotVec = new double[TopologyMain.gridIdxN + 5][TopologyMain.winSize + 5];
	int[][] gridAdjIdx = new int[TopologyMain.gridIdxN + 5][TopologyMain.nstream + 5];
	...
	// HashSet<Integer> pstreSet = new HashSet<Integer>();

	// ...........test...................//
//	public int ta = 17, tb = 18;
//	public double tt = 45;
	...
	public void localIdxRenew() {
		...
		// int[][] gridCoors = new int[TopologyMain.gridIdxN +
		// 5][TopologyMain.winSize + 5];
		// double[][] gridAffs = new double[TopologyMain.gridIdxN + 5][3 *
		// TopologyMain.nstream];
		// double[][] pivotVec = new double[TopologyMain.gridIdxN +
		// 5][TopologyMain.winSize + 5];

		// for (int i = 0; i < TopologyMain.gridIdxN; ++i) {
		// gridIdxFlag[i] = 0;
		// }
		gridIdxcnt = 0;
		pStreMap.clear();
